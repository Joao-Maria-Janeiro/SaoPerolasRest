            ...
            'Messages': [
                {
                    ...
                    "Variables": {
                        ...
                        "produto_1_t_preço": str(float(intent.metadata.get(products[0].name)) * products[0].price) + " €" if number_of_keys >= 1 else "", 
                        ...
                        "produto_2_t_preço": str(float(intent.metadata.get(products[1].name)) * products[1].price) + " €" if number_of_keys >= 2 else "", 
                        ...
                        "produto_3_t_preço": str(float(intent.metadata.get(products[2].name)) * products[2].price) + " €" if number_of_keys >= 3 else "", 
                        ...
                        "produto_4_t_preço": str(float(intent.metadata.get(products[3].name)) * products[3].price) + " €" if number_of_keys >= 4 else "", 
                        ...
                        "produto_5_t_preço": str(float(intent.metadata.get(products[4].name)) * products[4].price) + " €" if number_of_keys >= 5 else "", 
                        ...
                        "produto_6_t_preço": str(float(intent.metadata.get(products[5].name)) * products[5].price) + " €" if number_of_keys >= 6 else "", 
                        ...
                        "produto_7_t_preço": str(float(intent.metadata.get(products[6].name)) * products[6].price) + " €" if number_of_keys >= 7 else "", 
                        ...
                        "produto_8_t_preço": str(float(intent.metadata.get(products[7].name)) * products[7].price) + " €" if number_of_keys >= 8 else "", 
                        ...
                        "produto_9_t_preço": str(float(intent.metadata.get(products[8].name)) * products[8].price) + " €" if number_of_keys >= 9 else "", 
                        ...
                        "produto_10_t_preço": str(float(intent.metadata.get(products[9].name)) * products[9].price) + " €" if number_of_keys >= 10 else "", 
                        ...
                        "produto_11_t_preço": str(float(intent.metadata.get(products[10].name)) * products[10].price) + " €" if number_of_keys >= 11 else "", 
                        ...
                        "produto_12_t_preço": str(float(intent.metadata.get(products[11].name)) * products[11].price) + " €" if number_of_keys >= 12 else "", 
